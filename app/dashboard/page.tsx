...
import { Plus, User, ExternalLink, QrCode, MoreVertical, Trash2, Edit, Sparkles, AlertTriangle, X, ShieldAlert, ArrowRight } from "lucide-react";
    ...
    <div className="space-y-8">
        {isAdmin && (
          <motion.div 
            ...
            className="rounded-3xl bg-gradient-to-r from-amber-500 to-orange-600 p-6 text-white shadow-xl shadow-amber-500/20 flex flex-col md:flex-row items-center justify-between gap-4"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-black text-lg">Administrator Detected</h3>
                <p className="text-sm font-medium opacity-80">You have full access to the system intelligence and management tools.</p>
              </div>
            </div>
            <Link 
              href="/admin"
              className="flex items-center gap-2 rounded-2xl bg-white px-6 py-3 text-sm font-black text-amber-600 transition hover:bg-slate-50 active:scale-95"
            >
              Go to Admin Panel
